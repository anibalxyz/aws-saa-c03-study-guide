...
The system MUST detect completion via PageCompletionTrigger.client.js pairing IntersectionObserver (rootMargin 0px) with an always-on scroll backup listener and MUST persist progress in Nano Stores with localStorage.
