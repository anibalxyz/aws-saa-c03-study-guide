...
The system MUST inject title/sidebar frontmatter, MUST rewrite links preserving Move-to chain, MUST emit quiz JSON, MUST assert 283Q/217 diagrams, and MUST use placeholders plus paraphrase-plus-link only.
